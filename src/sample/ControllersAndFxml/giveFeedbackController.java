...
public class giveFeedbackController {
    ...
    void initialize() {
        ...
        assert leaveFeedbackButton != null : "fx:id=\"leaveFeedbackButton\" was not injected: check your FXML file 'purchaseDrug.fxml'.";
        ...
        assert TextArea != null : "fx:id=\"TextArea\" was not injected: check your FXML file 'purchaseDrug.fxml'.";

        BackButton.setOnAction(actionEvent -> { //setting action to the button back to go back to  the User Menu
            this.back(BackButton);
        });

        leaveFeedbackButton.setOnAction(event -> {
            ...
            controller.GiveFeedback(TextArea.getText(),nameField.getText());
            resultLabel.setText("Thanks for your feedback!");
        });
    }
