...
public class getDrugByManufacturerController {
    ...
    void initialize() {
        ...
        assert manufacturerField != null : "fx:id=\"manufacturerField\" was not injected: check your FXML file 'getDrugByManufacturer.fxml'.";
        ...
        SearchButton.setOnAction(event -> {
            ...
            List drug=controller.getDrugByManufacturer(manufacturerField.getText());
        ...
        prevButton.setOnAction(event -> {
            List drugs=controller.getDrugByManufacturer(manufacturerField.getText());
        ...
        NextButton.setOnAction(event -> {
            List drugs2=controller.getDrugByManufacturer(manufacturerField.getText());
