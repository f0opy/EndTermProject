...
public class getDrugByDestinyController {
    ...
    void initialize() {
        ...
        assert destinyField != null : "fx:id=\"destinyField\" was not injected: check your FXML file 'getDrugByName.fxml'.";
        ...
        SearchButton.setOnAction(event -> {  //setting action to the button search
            ...
            List drug=controller.getDrugByDestiny(destinyField.getText());  //creating new list to save result of calling method of controller
        ...
        prevButton.setOnAction(event -> {  //setting action to button prev
            List drugs=controller.getDrugByDestiny(destinyField.getText());  //creating new list to save result of calling method of controller
        ...
        NextButton.setOnAction(event -> { //setting action to button next
            List drugs2=controller.getDrugByDestiny(destinyField.getText());  //creating new list to save result of calling method of controller
