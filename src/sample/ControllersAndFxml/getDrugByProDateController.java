...
public class getDrugByProDateController {
    ...
    void initialize() {
        ...
        SearchButton.setOnAction(event -> {
            ...
            List drug=controller.getDrugProDate(date1);
        ...
        prevButton.setOnAction(event -> {
            LocalDate date= datePIcker.getValue();
            Date date1=Date.valueOf(date);
            List drugs=controller.getDrugProDate(date1);
        ...
        NextButton.setOnAction(event -> {
            LocalDate date= datePIcker.getValue();
            Date date1=Date.valueOf(date);
            List drugs2=controller.getDrugProDate(date1);
